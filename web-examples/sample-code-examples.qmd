...
Confidential CHIS data may utilize either replicate weights or the Taylor series linearization method, however replicate weights is strongly recommended over using Taylor series. PUF data may only utilize replicate weights. The required variables for the Taylor series linearization method (tsvarstr and tsvrunit) have not been included in the CHIS Public Use Files. 
...
chis_design |> 
  svyglm(formula = bmi_p ~ relevel(as.factor(srsex),ref="1") + 
